...

{
  ...
  my.nixgl-desktop.applications = {
    ...
    discord = {
      ...
      exec = "discord";
      icon = "discord";
      comment = "Chat application with hardware acceleration";
    ...
    blender = {
      ...
      exec = "blender";
      icon = "blender";
      comment = "3D modeling application with hardware acceleration";
      categories = ["Graphics" "3DGraphics"];
      nixGLVariant = "nixGLIntel"; # or nixGLNvidia for better performance
    };
  };
}