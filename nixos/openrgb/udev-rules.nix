...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="3938", ATTRS{idProduct}=="1229", TAG+="uaccess", TAG+="AOC_GK500"
#---------------------------------------------------------------#
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="0b05", ATTRS{idProduct}=="1a88", TAG+="uaccess", TAG+="ASUS_ROG_Strix_Impact_III"
...
#---------------------------------------------------------------#
# Asus Aura Ryuo AIO  - DetectAsusAuraUSBRyuoAIO
#---------------------------------------------------------------#
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="0b05", ATTRS{idProduct}=="1887", TAG+="uaccess", TAG+="ASUS_ROG_Ryuo_AIO"
#---------------------------------------------------------------#
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="0b05", ATTRS{idProduct}=="19fe", TAG+="uaccess", TAG+="ASUS_ROG_Strix_Flare_II"
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="0b05", ATTRS{idProduct}=="19f6", TAG+="uaccess", TAG+="ASUS_ROG_Strix_Scope_NX_Wireless_Deluxe_USB"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="0b05", ATTRS{idProduct}=="19f8", TAG+="uaccess", TAG+="ASUS_ROG_Strix_Scope_NX_Wireless_Deluxe_24GHz"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="0b05", ATTRS{idProduct}=="1ab5", TAG+="uaccess", TAG+="ASUS_ROG_Strix_Scope_II_RX"
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1b1c", ATTRS{idProduct}=="1b3f", TAG+="uaccess", TAG+="Corsair_K68_RED"
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1b1c", ATTRS{idProduct}=="1b7c", TAG+="uaccess", TAG+="Corsair_K100_RGB_Optical"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1b1c", ATTRS{idProduct}=="1bc5", TAG+="uaccess", TAG+="Corsair_K100_RGB_Optical"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1b1c", ATTRS{idProduct}=="1b7d", TAG+="uaccess", TAG+="Corsair_K100_MX_Red"
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1b1c", ATTRS{idProduct}=="1ba6", TAG+="uaccess", TAG+="Corsair_Slipstream_Wireless_Receiver_HW"
#---------------------------------------------------------------#
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1b1c", ATTRS{idProduct}=="1b5e", TAG+="uaccess", TAG+="Corsair_Harpoon_Wireless_Wired"
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1b1c", ATTRS{idProduct}=="1b65", TAG+="uaccess", TAG+="Corsair_Slipstream_Wireless_Receiver_SW"
...
#---------------------------------------------------------------#
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1044", ATTRS{idProduct}=="7a42", TAG+="uaccess", TAG+="Gigabyte_AORUS_ATC800"
#---------------------------------------------------------------#
...
#---------------------------------------------------------------#
# Gigabyte AORUS PC Case - DetectGigabyteAorusPCCaseControllers
#---------------------------------------------------------------#
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1044", ATTRS{idProduct}=="7a30", TAG+="uaccess", TAG+="Gigabyte_AORUS_C300_GLASS"
#---------------------------------------------------------------#
...
#---------------------------------------------------------------#
# Instant mouse - DetectInstantMouseControllers
#---------------------------------------------------------------#
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="30fa", ATTRS{idProduct}=="1030", TAG+="uaccess", TAG+="Advanced_GTA_250_USB_Gaming_Mouse"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="30fa", ATTRS{idProduct}=="1440", TAG+="uaccess", TAG+="Anko_KM43243952_USB_Gaming_Mouse"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="30fa", ATTRS{idProduct}=="1540", TAG+="uaccess", TAG+="Anko_KM43277483_USB_Gaming_Mouse"
#---------------------------------------------------------------#
...
#---------------------------------------------------------------#
# JGINYUEInternalUSB - DetectJGINYUEInternalUSB
#---------------------------------------------------------------#
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="0416", ATTRS{idProduct}=="a125", TAG+="uaccess", TAG+="JGINYUE_Internal_USB_Controller"
#---------------------------------------------------------------#
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="0cf2", ATTRS{idProduct}=="a104", TAG+="uaccess", TAG+="Lian_Li_Uni_Hub__AL_V2"
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="046d", ATTRS{idProduct}=="0a5c", TAG+="uaccess", TAG+="Logitech_G633_Gaming_Headset"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="046d", ATTRS{idProduct}=="0a89", TAG+="uaccess", TAG+="Logitech_G635_Gaming_Headset"
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="16d2", ATTRS{idProduct}=="1f01", TAG+="uaccess", TAG+="Nollie_8CH"
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1532", ATTRS{idProduct}=="02a3", TAG+="uaccess", TAG+="Razer_Ornata_V3_TKL"
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1532", ATTRS{idProduct}=="00a7", TAG+="uaccess", TAG+="Razer_Naga_Pro_V2_Wired"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1532", ATTRS{idProduct}=="00a8", TAG+="uaccess", TAG+="Razer_Naga_Pro_V2_Wireless"
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1532", ATTRS{idProduct}=="0c06", TAG+="uaccess", TAG+="Razer_Goliathus_Chroma_3XL"
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1532", ATTRS{idProduct}=="0560", TAG+="uaccess", TAG+="Razer_Kraken_Kitty_Black_Edition_V2"
...
#---------------------------------------------------------------#
# Roccat Burst Pro Air - DetectRoccatBurstProAirCoreControllers
#---------------------------------------------------------------#
#---------------------------------------------------------------#
...
#---------------------------------------------------------------#
# Roccat Kone Pro Mouse - DetectRoccatKoneProControllers
#---------------------------------------------------------------#
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1e7d", ATTRS{idProduct}=="2c88", TAG+="uaccess", TAG+="Roccat_Kone_Pro"
#---------------------------------------------------------------#
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1e7d", ATTRS{idProduct}=="69a0", TAG+="uaccess", TAG+="Roccat_Magma_Mini"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1e7d", ATTRS{idProduct}=="314c", TAG+="uaccess", TAG+="Roccat_Pyro"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1e7d", ATTRS{idProduct}=="307a", TAG+="uaccess", TAG+="Roccat_Vulcan_100_Aimo"
...
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1e7d", ATTRS{idProduct}=="30f7", TAG+="uaccess", TAG+="Roccat_Vulcan_Pro"
#---------------------------------------------------------------#
...
#---------------------------------------------------------------#
# Steel Series Rival 3 - DetectSteelSeriesAerox3
#---------------------------------------------------------------#
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1038", ATTRS{idProduct}=="1836", TAG+="uaccess", TAG+="SteelSeries_Aerox_3_Wired"
#---------------------------------------------------------------#
# Steel Series Rival 3 - DetectSteelSeriesAerox9
#---------------------------------------------------------------#
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="1038", ATTRS{idProduct}=="185a", TAG+="uaccess", TAG+="SteelSeries_Aerox_9_Wired"
#---------------------------------------------------------------#
...
#---------------------------------------------------------------#
# Valkyrie - DetectValkyrieKeyboardControllers
#---------------------------------------------------------------#
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="05ac", ATTRS{idProduct}=="024f", TAG+="uaccess", TAG+="Valkyrie_VK99_Pro"
SUBSYSTEMS=="usb|hidraw", ATTRS{idVendor}=="05ac", ATTRS{idProduct}=="024f", TAG+="uaccess", TAG+="Valkyrie_VK99"
#---------------------------------------------------------------#
