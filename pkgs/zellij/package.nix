# Vendored from nixpkgs@116036d to pin zellij at 0.43.1.
# Terminal transparency is broken since 0.44 (zellij-org/zellij#5175): PR #4992 introduced
# explicit black background padding on empty/trailing cells, overriding the terminal's default
# background and breaking transparency. Remove this file and the overlay entry once fixed upstream.
{
  lib,
  stdenv,
  rustPlatform,
